...
<i>Upon the release of ALX's System Engineering & DevOps project 0x19,
approximately 06:00 West African Time (WAT) here in Nigeria, an outage occurred on an isolated
Ubuntu 14.04 container running an Apache web server. GET requests on the server returned
`500` responses, when the expected response was an HTML file representing a
simple Holberton WordPress site.<i>
